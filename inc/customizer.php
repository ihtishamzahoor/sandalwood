...
function sandalwood_customize_register($wp_customize)
{
    ...
    // Change Header Image Text Section.
    $wp_customize->add_section('header_image_text',
        array(
            'title' => __('Header Image Title', 'sandalwood'),
            'priority' => 70,
            'capability' => 'edit_theme_options',
            'description' => __('Change Header Image Title for the front page.', 'sandalwood'),
        )
    );
    ...
    // Change Footer Text Section.
    $wp_customize->add_section('site_info',
        array(
            'title' => __('Footer', 'sandalwood'),
            'priority' => 80,
            'capability' => 'edit_theme_options',
            'description' => __('Change Footer Settings.', 'sandalwood'),
        )
    );
    ...
    // Add the controls.
    $wp_customize->add_control('sandalwood_site_info',
        array(
            'type' => 'input',
            'label' => __('Footer Text', 'sandalwood'),
            'section' => 'site_info',
            'settings' => 'site_info',
            'input_attrs' => array(
                'style' => 'width: 100%',
